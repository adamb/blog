...
As I was having my coffee this morning, I started thinking about how I might want to monitor a new website that I just built. I asked my friend ChatGBT and the first thing it suggested was Uptime Kuma, which I had not heard of. I have my own little Debian Linux box at my house and uh ChatGPT knows that. So it suggested that I just run a Docker command and get Uptime Kuma going. So I did. It was a nice little joyous experience.

So what is uptime kumal? It's a software package for monitoring other web pages. and it's free, it's open source, and it just works. With a single Docker command I was able to get it up and running. And uh add monitoring for a few websites that I care about.

So Uptime Kuma will basically go and get a web page or that sort of thing, every minute or so and if the web page doesn't load or it has some problems then it will send you an alert. So that brings up the next problem, how do I get the alert? Oh I thought about emails of course. But then I won't know until I check my email, which doesn't happen that often. These days 

# Pushover.net, the perfect companion

So that brings me to another thing that I really like, which is Pushover.net. Pushover is a really cool service where you can install an app on your phone and then set up alerts to be pushed to your phone for whatever reason you want. I've been using pushover I guess for over a year. It has a one-time purchase cost, which is very reasonable. I used it for a web site that I was creating about a year or so ago. And I also use it now to monitor things at my house like water tanks or freezer temperature or humidity. 

I was very happy to see you that Kuma supports Pushover natively, so I just had to go to my Pushover account and add a new app token. 
