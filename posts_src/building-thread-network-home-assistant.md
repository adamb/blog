...
Thread is a low-power mesh networking protocol that's becoming the backbone of modern smart homes. If you've been thinking about adding Thread devices to your Home Assistant setup, here's what you need to know.
...
The [ZBT-2](https://www.amazon.com/Home-Assistant-ZBT-2/s?k=Home+Assistant+ZBT-2) is the latest border router from the team behind Home Assistant, so that's the one I recommend getting. If you're building a HA system, this is the way to go. You can also build a thread network using [Apple Home Pod mini](https://www.apple.com/homepod-mini/) and [Eero](https://eero.com/), but if you're doing HA you should stick with the ZBT-2. It comes with a sturdy little base and 1.5 meter long cable so you can place it away from hardware interference.
...
- **Lighting**: [Philips Hue](https://www.amazon.com/Philips-Hue/s?k=Philips+Hue+Thread) (newer models)
- **Switches & Outlets**: [Eve Energy](https://www.amazon.com/Eve-Energy/s?k=Eve+Energy+Thread)
- **Sensors**: [Eve Room](https://www.amazon.com/Eve-Room/s?k=Eve+Room+Thread), [Eve Weather](https://www.amazon.com/Eve-Weather/s?k=Eve+Weather+Thread)
...
- **[Home Assistant Green](https://www.amazon.com/Home-Assistant-Green/s?k=Home+Assistant+Green)**
- **[Home Assistant ZBT-2](https://www.amazon.com/Home-Assistant-ZBT-2/s?k=Home+Assistant+ZBT-2)** USB radio configured as a **Thread Border Router**
...
### [Inovelli White Series Switches](https://www.amazon.com/Inovelli-White-Series/s?k=Inovelli+White+Series+Thread)
...
### [Eve Switches](https://www.amazon.com/Eve-Smart-Switch/s?k=Eve+Thread+Switch)
...
### [Onvis Thread Smart Plugs](https://www.amazon.com/Onvis-Smart-Plug/s?k=Onvis+Thread+Smart+Plug)
...
### [IKEA Thread Devices](https://www.amazon.com/IKEA-Thread/s?k=IKEA+Thread+Devices)
