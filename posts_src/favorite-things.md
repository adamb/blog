...
As I was having my coffee this morning, I started thinking about how I might want to monitor a new website that I just built. I asked my friend ChatGBT and the first thing it suggested was [Uptime Kuma](https://github.com/louislam/uptime-kuma), which I had not heard of. I have my own little Debian Linux box at my house and uh ChatGPT knows that. So it suggested that I just run a Docker command and get Uptime Kuma going. So I did. It was a nice little joyous experience.

So what is Uptime Kuma? It's a software package for monitoring other web pages. And it's free, it's open source, and it just works. With a single Docker command I was able to get it up and running. And uh add monitoring for a few websites that I care about.
...
So that brings me to another thing that I really like, which is [Pushover.net](https://pushover.net). Pushover is a really cool service where you can install an app on your phone and then set up alerts to be pushed to your phone for whatever reason you want. I've been using pushover I guess for over a year. It has a one-time purchase cost, which is very reasonable. I used it for a web site that I was creating about a year or so ago. And I also use it now to monitor things at my house like water tanks or freezer temperature or humidity. 
